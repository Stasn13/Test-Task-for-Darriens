    ...
    return (
      <CustomScrollbars className=" scrollbar">
        ...
        <li className="menu">
            <Button>
              <i className="zmdi zmdi-view-dashboard zmdi-hc-fw" />
              <span className="nav-text"><IntlMessages id="sidebar.testTask" /></span>
            </Button>
            <ul className="sub-menu">
              <li>
                <NavLink className="prepend-icon"
                  to="/app/test-task/albums">
                  <span className="nav-text"><IntlMessages
                    id="sidebar.testTask.albums" /></span>
                </NavLink>
              </li>
              <li>
                <NavLink className="prepend-icon"
                  to="/app/test-task/users">
                  <span className="nav-text"><IntlMessages
                    id="sidebar.testTask.users" /></span>
                </NavLink>
              </li>
            </ul>
        </li>
