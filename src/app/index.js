...
import TestTask from "./routes/testTask";
import {
  ABOVE_THE_HEADER,
  BELOW_THE_HEADER,
  COLLAPSED_DRAWER,
          ...
          <main className="app-main-content-wrapper">
            <div className="app-main-content">
              <Switch>
                ...
                <Route path={`${match.url}/test-task`} component={TestTask}/>
                ...
                {/* <Route path={`${match.url}/test-task`} 
                       component={asyncComponent(() => import('./routes/testTask/index'))}/> */}
              </Switch>
            </div>
            <Footer/>
          </main>
