            ...
            <div className="jr-card chart-user-statistics bg-primary darken-4 text-white">
              <div className="jr-dealclose-header px-4 mb-4">
                ...
                <div className="jr-dealclose-header-right">
                  <p className="mb-2"><span style={{backgroundColor: "#3BB4A3"}} className="size-8 rounded-circle d-inline-block mr-1"/>Expanse</p>
                  <p className="ml-2 mb-2"><span style={{backgroundColor:'#FF9800'}} className="size-8 rounded-circle d-inline-block mr-1"/>Income</p>
                </div>
              </div>
              ...
              <div className="row no-gutters">
                ...
                <div className="col-6">
                  <div className="stack-order py-4 px-2">
                    ...
                    <span className="h5 text-red"><i className="zmdi zmdi-long-arrow-return zmdi-hc-fw zmdi-hc-rotate-90"/>20%</span>
                  </div>
                </div>
              </div>
            </div>
