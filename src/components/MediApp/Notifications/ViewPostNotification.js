...
class ViewPostNotification extends Component {
  ...
  render() {
    ...
    return (
      <TouchableOpacity style={[styles.postContainer, baseStyles.media, baseStyles.alignItemsCenter]}
                        onPress={() => Actions.postDetail({postId: this.props.notification.object_id})}>
        ...
        <View style={[baseStyles.mediaBody, {marginBottom: 15}]}>
...
export default ViewPostNotification;
