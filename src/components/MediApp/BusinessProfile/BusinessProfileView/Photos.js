...
// import {photosGallery} from "../CreateBusinessPage/data";
  ...
  render() {
    return (
      <View style={styles.container}>
        <View style={styles.sectionContainer}>
          <FlatList
            data={this.props.businessPage.galleryData.galleryMedia}
            numColumns={2}
            style={{
              width: (win.width - 20),
              marginLeft: 10,
...
export default connect(mapStateToProps, {getBusinessPageDetail})(Photos);