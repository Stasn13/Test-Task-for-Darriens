...
class addMoreMembers extends Component {
  ...
  state = { selectedUser: [], isChange: false, listItems: [] };
            ...
            <AppHeaderButton
              ...
              onPress={() => {
                ...
                if (filteredUsers.length > 0) {
                  this.props.otherThis.updateMoreMembers(filteredUsers);
                  Actions.pop();
                } else {
...
export default connect(mapStateToProps, { getFollowing, changeMediChatAction })(addMoreMembers);
